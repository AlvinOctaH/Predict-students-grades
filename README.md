...
## Result
<p align="justify">
The test loss of 0.2261 indicates the accuracy of the trained RNN model in predicting GPA scores based on the scores of four previous GPA scores. In this case, the test loss is a measure of the difference between the predicted GPA scores and the actual GPA scores in the test set, calculated using the mean squared error (MSE) loss function.
</p>
<p align="justify">
